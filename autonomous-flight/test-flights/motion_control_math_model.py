...
def field_detection_tour(): 
    ...
    cmds.add(Command( 0, 0, 0, mavutil.mavlink.MAV_FRAME_GLOBAL_TERRAIN_ALT, mavutil.mavlink.MAV_CMD_NAV_WAYPOINT, 0, 0, 2, 0, 0, 0, 36.9778590 ,37.3033006 , 0.4))# Dummy 3 Su alma alanı
