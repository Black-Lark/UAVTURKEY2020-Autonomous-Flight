...
def second_tour(lat,lon):
    ...
    cmds.add(Command( 0, 0, 0, mavutil.mavlink.MAV_FRAME_GLOBAL_TERRAIN_ALT, mavutil.mavlink.MAV_CMD_NAV_WAYPOINT, 0, 0, 2, 0, 0, 0, lat , lon, 8))# Su bırakma
...
frame_pos = []
r_square = []
while vehicle.commands.next <=29:
